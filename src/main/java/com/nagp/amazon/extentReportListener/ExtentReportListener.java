/*package com.nagp.amazon.extentReportListener;
...
public class ExtentReportListener<ExtentReports> implements IReporter {
	private ExtentReports extent;

	
	 * public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites,
	 * String outputDirectory) { extent = new ExtentReports(outputDirectory +
	 * File.separator + "Amazon_Extent_Report.html", true);
	 * 
